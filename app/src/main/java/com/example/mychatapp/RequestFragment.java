...
public class RequestFragment extends Fragment {
                                ...
                                if(type.equals("received")){
                                    UserRef.child(list_user_id).addValueEventListener(new ValueEventListener() {
                                        ...
                                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                                            if(snapshot.hasChild("image")){
                                                ...
                                                final String requesetProfileImage = snapshot.child("image").getValue().toString();

                                                Picasso.get().load(requesetProfileImage).into(holder.profileimage);

                                            }

                                            final String requesetUserName = snapshot.child("name").getValue().toString();
                                            final String requesetUserStatus = snapshot.child("status").getValue().toString();
                                            holder.userName.setText(requesetUserName);
                                            ...
                                            holder.itemView.setOnClickListener(new View.OnClickListener() {
                                                ...
                                                public void onClick(View view) {
                                                    ...
                                                    builder.setTitle(requesetUserName+"  Chat Request");
                                    ...
                                    UserRef.child(list_user_id).addValueEventListener(new ValueEventListener() {
                                        ...
                                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                                            ...
                                            final String requesetUserStatus = snapshot.child("status").getValue().toString();
                                            holder.userName.setText(requesetUserName);
                                            holder.userStatus.setText("you have sent a request to "+requesetUserName);
                                                                                ...
                                                                                if(task.isSuccessful()){
                                                                                    ChatRequestRef.child(list_user_id).child(currentUserId)
                                                                                            ...
                                                                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                                ...
                                                                                                public void onComplete(@NonNull Task<Void> task) {
                                                                                                    if(task.isSuccessful()){
                                                                                                        Toast.makeText(getContext(), "you have cancelled that request", Toast.LENGTH_SHORT).show();
    ...
    public static class RequestsViewHolder extends RecyclerView.ViewHolder{
        ...
        Button AceptButton, CancelButton;
        ...
        public RequestsViewHolder(@NonNull View itemView) {
            ...
            AceptButton = itemView.findViewById(R.id.request_accept_btn);
